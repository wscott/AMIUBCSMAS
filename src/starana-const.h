...
const myString STARANA_VERSION = "0.2g4";
const myString STARANA_RELDATE = "8 Dec 1998";
...
// gate statistics
const int gate_mass[7] =     {100,  -1, 150, 300, 100,  -1, -1};
const int gate_distance[7] = {250, 300, 600, 500,  -1, 800, -1};
