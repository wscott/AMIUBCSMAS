...
FD_PlanetStatus *create_form_PlanetStatus(void)
{
  ...
  obj = fl_add_button(FL_NORMAL_BUTTON,10,450,90,30,"View Simulation");
    fl_set_object_callback(obj,pscb_viewsimulation,0);
  obj = fl_add_button(FL_NORMAL_BUTTON,110,450,70,30,"Fire Packet");
    fl_set_object_callback(obj,pscb_firepacket,0);
  obj = fl_add_button(FL_NORMAL_BUTTON,190,450,70,30,"Bomb Planet");
...
FD_PacketFiring *create_form_PacketFiring(void)
{
  ...
  fdui->PacketFiring = fl_bgn_form(FL_NO_BOX, 480, 400);
  obj = fl_add_box(FL_UP_BOX,0,0,480,400,"");
  obj = fl_add_frame(FL_ENGRAVED_FRAME,20,235,440,120,"");
  obj = fl_add_labelframe(FL_ENGRAVED_FRAME,5,10,200,180,"Planet #1");
  fdui->planetname[0] = obj = fl_add_text(FL_NORMAL_TEXT,10,15,190,25,"Wammalammadingdong");
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_lalign(obj,FL_ALIGN_CENTER|FL_ALIGN_INSIDE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
  ...
  fdui->racenotes[0] = obj = fl_add_text(FL_NORMAL_TEXT,10,140,190,48,"Racial notes");
    fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
  ...
  fdui->defcoverage[0] = obj = fl_add_text(FL_NORMAL_TEXT,130,120,60,20,"(99.45%)");
    fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
  obj = fl_add_labelframe(FL_ENGRAVED_FRAME,275,10,200,180,"Planet #2");
  fdui->planetname[1] = obj = fl_add_text(FL_NORMAL_TEXT,280,15,190,25,"Wammalammadingdong");
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_lalign(obj,FL_ALIGN_CENTER|FL_ALIGN_INSIDE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
  fdui->twindriver[1] = obj = fl_add_lightbutton(FL_PUSH_BUTTON,400,60,60,30,"Twin");
    fl_set_object_boxtype(obj,FL_NO_BOX);
    fl_set_object_callback(obj,pfcb_computepacket,1);
  fdui->racenotes[1] = obj = fl_add_text(FL_NORMAL_TEXT,280,140,190,48,"Racial notes");
    fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
  ...
  fdui->driverwarp[0] = obj = fl_add_text(FL_NORMAL_TEXT,50,60,40,30,"W");
    ...
    fl_set_object_lalign(obj,FL_ALIGN_CENTER|FL_ALIGN_INSIDE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
  obj = fl_add_scrollbutton(FL_TOUCH_BUTTON,90,60,30,30,"6");
    fl_set_object_boxtype(obj,FL_BORDER_BOX);
    fl_set_object_callback(obj,pfcb_increasewarp,0);
  obj = fl_add_scrollbutton(FL_TOUCH_BUTTON,20,60,30,30,"4");
    fl_set_object_boxtype(obj,FL_BORDER_BOX);
    fl_set_object_callback(obj,pfcb_decreasewarp,0);
  fdui->driverwarp[1] = obj = fl_add_text(FL_NORMAL_TEXT,320,60,40,30,"W");
    fl_set_object_boxtype(obj,FL_BORDER_BOX);
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_lalign(obj,FL_ALIGN_CENTER|FL_ALIGN_INSIDE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
  obj = fl_add_scrollbutton(FL_TOUCH_BUTTON,360,60,30,30,"6");
    fl_set_object_boxtype(obj,FL_BORDER_BOX);
    fl_set_object_callback(obj,pfcb_increasewarp,1);
  obj = fl_add_scrollbutton(FL_TOUCH_BUTTON,290,60,30,30,"4");
    fl_set_object_boxtype(obj,FL_BORDER_BOX);
    fl_set_object_callback(obj,pfcb_decreasewarp,1);
  ...
  fdui->packetdirection = obj = fl_add_button(FL_NORMAL_BUTTON,210,40,60,30,"@5");
    fl_set_object_callback(obj,pfcb_switchdirection,0);
  fdui->dir = 0;
  fdui->planetdistance = obj = fl_add_text(FL_NORMAL_TEXT,210,110,60,20,"9999 l.y.");
    fl_set_object_lalign(obj,FL_ALIGN_CENTER|FL_ALIGN_INSIDE);
  fdui->close = obj = fl_add_button(FL_NORMAL_BUTTON,400,360,70,30,"Close");
  ...
  fdui->mineralspent = obj = fl_add_counter(FL_NORMAL_COUNTER,110,200,180,20,"Minerals spent: ");
    ...
    fl_set_counter_bounds(obj, 0.0, 100000);
    fl_set_counter_precision(obj, 0);
    fl_set_object_callback(obj,pfcb_computepacket,-100);
  ...
  for (i = 0; i < 4; i++) {
    fdui->warp[i] = obj = fl_add_text(FL_NORMAL_TEXT,30,270 + 20*i,40,20,"7");
    fl_set_object_lalign(obj,FL_ALIGN_CENTER|FL_ALIGN_INSIDE);
    fdui->travel[i] = obj = fl_add_text(FL_NORMAL_TEXT,70,270 + 20*i,40,20,"3");
    fl_set_object_lalign(obj,FL_ALIGN_CENTER|FL_ALIGN_INSIDE);
    fdui->mineral[i] = obj = fl_add_text(FL_NORMAL_TEXT,110,270 + 20*i,90,20,"22700 / 22700");
    fl_set_object_lalign(obj,FL_ALIGN_CENTER|FL_ALIGN_INSIDE);
    fdui->colkill[i] = obj = fl_add_text(FL_NORMAL_TEXT,200,270 + 20*i,100,20,"769500 / 175900");
    fl_set_object_lalign(obj,FL_ALIGN_CENTER|FL_ALIGN_INSIDE);
    fdui->defdestroy[i] = obj = fl_add_text(FL_NORMAL_TEXT,300,270 + 20*i,80,20,"27 / 56");
    fl_set_object_lalign(obj,FL_ALIGN_CENTER|FL_ALIGN_INSIDE);
    fdui->terraform[i] = obj = fl_add_text(FL_NORMAL_TEXT,390,270 + 20*i,60,20,"12 / 1");
    fl_set_object_lalign(obj,FL_ALIGN_CENTER|FL_ALIGN_INSIDE);
  }
  fl_end_form();
...
FD_RR_RaceInfo *create_form_RR_RaceInfo(void)
{
  ...
  obj = fl_add_text(FL_NORMAL_TEXT,170,80,140,20,"Max resources/100% world:");
    fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
  obj = fl_add_text(FL_NORMAL_TEXT,390,60,70,20,"Habitability:");
    fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
  ...
  fdui->explored = obj = fl_add_text(FL_NORMAL_TEXT,460,60,150,20,"");
    fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
...
FD_RR_Objects *create_form_RR_Objects(void)
{
  ...
  obj = fl_add_text(FL_NORMAL_TEXT,290,8,40,16,"Res");
    fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
  obj = fl_add_text(FL_NORMAL_TEXT,330,8,100,16,"Base hull");
    fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
  ...
  for (i = 0; i < 8; i++) {
    ...
    fdui->resources[i] = obj = fl_add_text(FL_NORMAL_TEXT,290,26 + 16*i,40,16,"Res");
      fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
    fdui->basehull[i] = obj = fl_add_text(FL_NORMAL_TEXT,330,26 + 16*i,100,16,"(base hull)");
      fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
  }

  obj = fl_add_text(FL_NORMAL_TEXT,30,180,140,20,"Factory");
    fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
  obj = fl_add_text(FL_NORMAL_TEXT,30,196,140,20,"Mine");
    fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
  obj = fl_add_text(FL_NORMAL_TEXT,30,214,140,20,"Defense");
    fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
  obj = fl_add_text(FL_NORMAL_TEXT,30,230,140,20,"Terraforming");
    fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);

  for (i = 0; i < 4; i++) {
    fdui->minerals[i+8][0] = obj = fl_add_text(FL_NORMAL_TEXT,170,180 + i*16,40,20,"Iron");
      fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
    fdui->minerals[i+8][1] = obj = fl_add_text(FL_NORMAL_TEXT,210,180 + i*16,40,20,"Bora");
      fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
    fdui->minerals[i+8][2] = obj = fl_add_text(FL_NORMAL_TEXT,250,180 + i*16,40,20,"Germ");
      fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
    fdui->resources[i+8] = obj = fl_add_text(FL_NORMAL_TEXT,290,180 + i*16,40,20,"Res");
      fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
  }
  fl_end_form();
