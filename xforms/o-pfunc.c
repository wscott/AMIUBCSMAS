...
FD_RR_DesignsObjects *create_form_RR_DesignsObjects(void)
{
  ...
  obj = fl_add_box(FL_UP_BOX,0,0,610,290,"");
  obj = fl_add_text(FL_NORMAL_TEXT,30,10,140,20,"Design name 1");
    fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
  obj = fl_add_text(FL_NORMAL_TEXT,170,10,40,20,"Iron");
    fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
  obj = fl_add_text(FL_NORMAL_TEXT,210,10,40,20,"Bora");
    fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
  obj = fl_add_text(FL_NORMAL_TEXT,250,10,40,20,"Germ");
    fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
  obj = fl_add_text(FL_NORMAL_TEXT,290,10,40,20,"Res");
    fl_set_object_lalign(obj,FL_ALIGN_LEFT|FL_ALIGN_INSIDE);
